...
public class BrandController {
    ...
    public Result<Brand>  findById(@PathVariable(name="id") Integer id){
        ...
        if(brand != null){
            ...
            return new Result<Brand>(false,StatusCode.OK,"品牌不存在");
    }
    /**
     * 添加品牌数据
     * @param brand
    ...
    public Result<PageInfo> findPage(@PathVariable(value="page")Integer page,@PathVariable(value="size") Integer size){
        ...
        return new Result<PageInfo>(true,StatusCode.OK,"分页查询成功",info);
    }
    ...
    public Result<PageInfo> findPage(@PathVariable(value="page")Integer page,@PathVariable(value="size") Integer size,@RequestBody  Brand brand){
    ...
    public Result<List<Brand>> findByCategoryId(@PathVariable Integer categoyrId){
        List<Brand> list = brandService.findByCategoryId(categoyrId);
        return new Result<List<Brand>>(true,StatusCode.OK,"根据分类id查询品牌成功",list);
